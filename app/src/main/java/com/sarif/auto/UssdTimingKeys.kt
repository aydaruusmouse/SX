 ...
 * [SecurePrefs] stores each [key]. Defaults target ~2–3s balance and ~6–8s transfer with main
 * settings interval 1s, step delay 200ms, AX min gap 1500ms. Increase if PIN/capture fails.
 */
object UssdTimingKeys {
    ...
    val DEFINITIONS: List<Def> = listOf(
        ...
        Def("ussd_t_transfer_pre_delay_cap_ms", R.string.ussd_timing_transfer_pre_delay_cap, 180L, 0L),
        Def("ussd_t_dismiss_before_transfer_ms", R.string.ussd_timing_dismiss_before_transfer, 180L, 0L),
        // —— Telephony ——
        ...
        Def("ussd_t_balance_min_delay_before_pin_ms", R.string.ussd_timing_balance_min_delay_before_pin, 350L, 0L),
        Def("ussd_t_balance_pin_retry_after_fail_ms", R.string.ussd_timing_balance_pin_retry_after_fail, 700L, 0L),
        Def("ussd_t_balance_menu_merge_read_timeout_ms", R.string.ussd_timing_balance_menu_merge_read_timeout, 3_200L, 0L),
        Def("ussd_t_balance_pin_after_open_timeout_ms", R.string.ussd_timing_balance_pin_after_open_timeout, 12_000L, 0L),
        ...
        Def("ussd_t_balance_menu_one_pre_await_quick_ms", R.string.ussd_timing_balance_menu_one_pre_await_quick, 60L, 0L),
        Def("ussd_t_balance_menu_one_pre_await_slow_ms", R.string.ussd_timing_balance_menu_one_pre_await_slow, 120L, 0L),
        ...
        Def("ussd_t_send_between_step_menu_max_ms", R.string.ussd_timing_send_between_step_menu_max, 100L, 0L),
    ...
    const val DEFAULT_AX_READ_CAPTURE_FINALIZE_MS = "1200,2800"
